    ...
    <section className={`${sectionShell} bg-[#0c0d12]`}>
      <div className={containerShell}>
        <FadeIn className={sectionIntro}>
          ...
          <h2 className={sectionTitle}>
            Evo kako to izgleda <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">u praksi</span>
          </h2>
        </FadeIn>

        <FadeIn delay={0.1}>
          <div className="group flex flex-col md:flex-row rounded-2xl border border-white/[0.15] bg-white/[0.07] overflow-hidden transition-all duration-300 hover:border-white/20 hover:shadow-lg">
            {/* Image left */}
            <div className="md:w-1/2 relative min-h-[300px] md:min-h-full overflow-hidden">
              <Image
                src="/tambnejl.jpeg"
                alt="BG Rent a Car — transformacija sistema"
                fill
            ...
            <div className="md:w-1/2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
              <span className="text-cyan-400 text-xs font-semibold uppercase tracking-widest mb-3">Rent-a-car · Beograd</span>
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">BG Rent a Car &amp; Limo Service</h3>
              <p className="text-base leading-7 text-white/75 sm:text-lg sm:leading-8 mb-8">
                Zastareo sajt bez sistema za upravljanje rezervacijama. Zamenjen kompletnom platformom sa admin panelom i booking flowom za klijente i vlasnike.
              </p>
              <div>
                <motion.a
                  href="/case-study/bg-rent-a-car"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-2 rounded-full bg-cyan-400 px-6 py-3 text-sm font-bold text-black transition-colors hover:bg-cyan-300"
                >
                  Pročitaj case study <ArrowRight className="w-4 h-4" />
                </motion.a>
              </div>
            </div>
          </div>
